...
<body>
    <div id="header">
        ...
        <div class="container">
            <div class="row">
                <div class="offset-md-4 col-md-4 pt-5 pb-4">
                    <div class="logo">
                        <a  href="#"><img height="100" src="http://182.160.97.196:8088/studentportal/assets/nub-big-logo-e909d7e3005bdaf2fed2701ad5fd998a.png"></a>
                    </div>
                </div>
                ...
                <div class="row m-auto">
                    <div class="col">
                        <h2 class="text-danger text-center mb-3 d-block">Library management system</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="menu">
                        ...
                        <li class="{{ request()->is('publishers') ? 'active':'' }}"><a href="{{ route('publishers') }}">Publishers</a></li>
    ...
    <div id="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <span>© Copyright 2022 <a href="#">Team 06 😎</a></span>
                </div>
            </div>
        </div>
    </div>
